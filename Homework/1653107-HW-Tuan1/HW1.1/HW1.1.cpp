// HW1.1.cpp : Defines the entry point for the application.
//
	...
	_In_ int       nCmdShow)
{
	...
	*/
	...
	LoadStringW(hInstance, IDC_HW11, szWindowClass, MAX_LOADSTRING);
	...
	*/
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_HW11));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HW11));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_HW11);
